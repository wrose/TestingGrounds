...
template<class T>
void ATile::RandomlyPlaceActors(TSubclassOf<T> ToSpawn, FGenerationParameters GenerationParameters)
{
...
FSpawnPosition ATile::GenerateSpawnPosition(FGenerationParameters GenerationParameters) {
